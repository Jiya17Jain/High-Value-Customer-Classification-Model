...
This project builds a supervised machine learning model to predict whether a customer is a high-value spender based on demographic and purchasing behavior features.  The objective is to help businesses proactively identify high-revenue customers and design targeted marketing strategies to maximize retention and profitability.

End‑to‑end Data Science project:

Exploratory Data Analysis ➜ Feature Engineering ➜ Classification Modeling ➜ Model Comparison
